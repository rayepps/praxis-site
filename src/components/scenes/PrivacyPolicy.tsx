...
export default function PrivacyPolicyScene() {
  ...
  return (
    ...
    >
      <Section>
        <Heading marginTop={majorScale(2)} size={900}>Privacy Policy</Heading>
        <P size={300}>Last updated: October 26, 2021</P>
      </Section>
      <P>This Privacy Policy describes Our policies and procedures on the collection, use and disclosure of Your information when You use the Service and tells You about Your privacy rights and how the law protects You.</P>
      <P>We use Your Personal data to provide and improve the Service. By using the Service, You agree to the collection and use of information in accordance with this Privacy Policy. This Privacy Policy has been created with the help of the <a href="https://www.termsfeed.com/privacy-policy-generator/" target="_blank">Privacy Policy Generator</a>.</P>
      <Section>
        <Heading marginTop={majorScale(2)} size={800}>Interpretation and Definitions</Heading>
        <Heading marginTop={majorScale(2)} size={600}>Interpretation</Heading>
        <P>The words of which the initial letter is capitalized have meanings defined under the following conditions. The following definitions shall have the same meaning regardless of whether they appear in singular or in plural.</P>
        <Heading marginTop={majorScale(2)} size={600}>Definitions</Heading>
        ...
        <List>
          ...
          <li><P>
            <P><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to The Praxis Tactical &amp; Apparel Company.</P>
          </P></li>
          <li><P>
          ...
          <li><P>
            <P><strong>Website</strong> refers to Praxis, accessible from <a href="https://praxisco.us" rel="external nofollow noopener" target="_blank">https://praxisco.us</a></P>
          </P></li>
          <li><P>
      ...
      <Section>
        <Heading marginTop={majorScale(2)} size={800}>Collecting and Using Your Personal Data</Heading>
        <Heading marginTop={majorScale(2)} size={700}>Types of Data Collected</Heading>
        <Heading marginTop={majorScale(2)} size={300}>Personal Data</Heading>
        ...
        <Heading marginTop={majorScale(2)} size={300}>Usage Data</Heading>
        ...
        <Heading marginTop={majorScale(2)} size={300}>Tracking Technologies and Cookies</Heading>
        ...
        <Heading marginTop={majorScale(2)} size={700}>Use of Your Personal Data</Heading>
        ...
        <Heading marginTop={majorScale(2)} size={700}>Retention of Your Personal Data</Heading>
        ...
        <Heading marginTop={majorScale(2)} size={700}>Transfer of Your Personal Data</Heading>
        ...
        <Heading marginTop={majorScale(2)} size={700}>Disclosure of Your Personal Data</Heading>
        <Heading marginTop={majorScale(2)} size={300}>Business Transactions</Heading>
        <P>If the Company is involved in a merger, acquisition or asset sale, Your Personal Data may be transferred. We will provide notice before Your Personal Data is transferred and becomes subject to a different Privacy Policy.</P>
        <Heading marginTop={majorScale(2)} size={300}>Law enforcement</Heading>
        <P>Under certain circumstances, the Company may be required to disclose Your Personal Data if required to do so by law or in response to valid requests by public authorities (e.g. a court or a government agency).</P>
        <Heading marginTop={majorScale(2)} size={300}>Other legal requirements</Heading>
        ...
        <Heading marginTop={majorScale(2)} size={700}>Security of Your Personal Data</Heading>
        <P>The security of Your Personal Data is important to Us, but remember that no method of transmission over the Internet, or method of electronic storage is 100% secure. While We strive to use commercially acceptable means to protect Your Personal Data, We cannot guarantee its absolute security.</P>
        <Heading marginTop={majorScale(2)}>Children's Privacy</Heading>
        ...
        <Heading marginTop={majorScale(2)}>Links to Other Websites</Heading>
        <P>Our Service may contain links to other websites that are not operated by Us. If You click on a third party link, You will be directed to that third party's site. We strongly advise You to review the Privacy Policy of every site You visit.</P>
        <P>We have no control over and assume no responsibility for the content, privacy policies or practices of any third party sites or services.</P>
        <Heading marginTop={majorScale(2)}>Changes to this Privacy Policy</Heading>
        <P>We may update Our Privacy Policy from time to time. We will notify You of any changes by posting the new Privacy Policy on this page.</P>
        <P>We will let You know via email and/or a prominent notice on Our Service, prior to the change becoming effective and update the &quot;Last updated&quot; date at the top of this Privacy Policy.</P>
        <P>You are advised to review this Privacy Policy periodically for any changes. Changes to this Privacy Policy are effective when they are posted on this page.</P>
      </Section>
      <Heading marginTop={majorScale(2)}>Contact Us</Heading>
      <P>If you have any questions about this Privacy Policy, You can contact us:</P>
      <List>
        <li><P>By email: support@praxisco.us</P></li>
      </List>
    </Pane>
  )
}