            ...
            <div className="max-w-screen-md">
              ...
              <div className="my-6 flex flex-col md:flex-row rounded-lg bg-gray-50 items-center p-6">
                <div className="grow pr-6">
                  ...
                  <p className="text-lg text-center md:text-left font-medium max-w-prose">
                    Read the rest at {event.training.company.name}. Course instructors, directions, required equipment,
                    and other details await.
                  </p>
                </div>
                <a
                  href={
                  ...
                  target="_blank"
                  className="p-2 bg-black flex flex-row text-center items-center justify-center text-white w-full md:w-auto mt-4 md:mt-0 rounded font-bold whitespace-nowrap"
                >
                  <span>Go Now</span>
