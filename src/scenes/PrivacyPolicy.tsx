  ...
  return (
    <div className="p-4">
      <div className="mb-4">
        ...
        <p className="max-w-prose text-xl">Last updated: October 26, 2021</p>
      </div>
      ...
      <div className="mb-4">
        <h2 className="mt-2 text-4xl">Interpretation and Definitions</h2>
        <h2 className="mt-2 text-3xl">Interpretation</h2>
        <p className="max-w-prose">
          The words of which the initial letter is capitalized have meanings defined under the following conditions. The
          following definitions shall have the same meaning regardless of whether they appear in singular or in plural.
        </p>
        <h2 className="mt-2 text-3xl">Definitions</h2>
        <p className="max-w-prose">For the purposes of this Privacy Policy:</p>
        <ul className="mt-2">
          <li className="list-disc relative left-12">
            <p className="max-w-prose">
              <p className="max-w-prose">
                <strong className="text-bold">Account</strong> means a unique account created for You to access our Service or parts of our
                Service.
              </p>
            </p>
          </li>
          <li className="list-disc relative left-12">
            <p className="max-w-prose">
              <p className="max-w-prose">
                <strong className="text-bold">Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot;
                or &quot;Our&quot; in this Agreement) refers to The Praxis Tactical &amp; Apparel Company.
              </p>
            </p>
          </li>
          <li className="list-disc relative left-12">
            <p className="max-w-prose">
              <p className="max-w-prose">
                <strong className="text-bold">Cookies</strong> are small files that are placed on Your computer, mobile device or any other
          ...
          <li className="list-disc relative left-12">
            <p className="max-w-prose">
              <p className="max-w-prose">
                <strong className="text-bold">Country</strong> refers to: Idaho, United States
              </p>
            </p>
          </li>
          <li className="list-disc relative left-12">
            <p className="max-w-prose">
              <p className="max-w-prose">
                <strong className="text-bold">Device</strong> means any device that can access the Service such as a computer, a cellphone or
                a digital tablet.
              </p>
            </p>
          </li>
          <li className="list-disc relative left-12">
            <p className="max-w-prose">
              <p className="max-w-prose">
                <strong className="text-bold">Personal Data</strong> is any information that relates to an identified or identifiable
                individual.
              </p>
            </p>
          </li>
          <li className="list-disc relative left-12">
            <p className="max-w-prose">
              <p className="max-w-prose">
                <strong className="text-bold">Service</strong> refers to the Website.
              </p>
            </p>
          </li>
          <li className="list-disc relative left-12">
            <p className="max-w-prose">
              <p className="max-w-prose">
                <strong className="text-bold">Service Provider</strong> means any natural or legal person who processes the data on behalf of
          ...
          <li className="list-disc relative left-12">
            <p className="max-w-prose">
              <p className="max-w-prose">
                <strong className="text-bold">Usage Data</strong> refers to data collected automatically, either generated by the use of the
          ...
          <li className="list-disc relative left-12">
            <p className="max-w-prose">
              <p className="max-w-prose">
                <strong className="text-bold">Website</strong> refers to Praxis, accessible from{' '}
                <a href="https://praxisco.us" rel="external nofollow noopener" target="_blank">
                  https://praxisco.us
                </a>
              </p>
            </p>
          ...
          <li className="list-disc relative left-12">
            <p className="max-w-prose">
              <p className="max-w-prose">
                <strong className="text-bold">You</strong> means the individual accessing or using the Service, or the company, or other legal
      ...
      <div className="mb-4">
        <h2 className="mt-2 text-4xl">Collecting and Using Your Personal Data</h2>
        <h2 className="mt-2 text-3xl">Types of Data Collected</h2>
        <h2 className="mt-2 text-2xl">Personal Data</h2>
        <p className="max-w-prose">
        ...
        <ul className="mt-2">
          <li className="list-disc relative left-12">
            <p className="max-w-prose">
              <p className="max-w-prose">Email address</p>
            </p>
          </li>
          <li className="list-disc relative left-12">
            <p className="max-w-prose">
              <p className="max-w-prose">First name and last name</p>
            </p>
          </li>
          <li className="list-disc relative left-12">
            <p className="max-w-prose">
              <p className="max-w-prose">Phone number</p>
            </p>
          </li>
          <li className="list-disc relative left-12">
            <p className="max-w-prose">
              <p className="max-w-prose">Usage Data</p>
            </p>
          </li>
        </ul>
        <h2 className="mt-2 text-2xl">Usage Data</h2>
        <p className="max-w-prose">Usage Data is collected automatically when using the Service.</p>
        <p className="max-w-prose">
        ...
        <h2 className="mt-2 text-2xl">Tracking Technologies and Cookies</h2>
        <p className="max-w-prose">
        ...
        <ul className="mt-2">
          <li className="list-disc relative left-12">
            <p className="max-w-prose">
              <strong className="text-bold">Cookies or Browser Cookies.</strong> A cookie is a small file placed on Your Device. You can
          ...
          <li className="list-disc relative left-12">
            <p className="max-w-prose">
              <strong className="text-bold">Flash Cookies.</strong> Certain features of our Service may use local stored objects (or Flash
          ...
          <li className="list-disc relative left-12">
            <p className="max-w-prose">
              <strong className="text-bold">Web Beacons.</strong> Certain divs of our Service and our emails may contain small electronic
              ...
              related website statistics (for example, recording the popularity of a certain div and verifying system
        ...
        <p className="max-w-prose">We use both Session and Persistent Cookies for the purposes set out below:</p>
        <ul className="mt-2">
          <li className="list-disc relative left-12">
            <p className="max-w-prose">
              <p className="max-w-prose">
                <strong className="text-bold">Necessary / Essential Cookies</strong>
              </p>
              <p className="max-w-prose">Type: Session Cookies</p>
              <p className="max-w-prose">Administered by: Us</p>
              <p className="max-w-prose">
          ...
          <li className="list-disc relative left-12">
            <p className="max-w-prose">
              <p className="max-w-prose">
                <strong className="text-bold">Cookies Policy / Notice Acceptance Cookies</strong>
              </p>
              <p className="max-w-prose">Type: Persistent Cookies</p>
              <p className="max-w-prose">Administered by: Us</p>
              <p className="max-w-prose">Purpose: These Cookies identify if users have accepted the use of cookies on the Website.</p>
            </p>
          </li>
          <li className="list-disc relative left-12">
            <p className="max-w-prose">
              <p className="max-w-prose">
                <strong className="text-bold">Functionality Cookies</strong>
              </p>
              <p className="max-w-prose">Type: Persistent Cookies</p>
              <p className="max-w-prose">Administered by: Us</p>
              <p className="max-w-prose">
        ...
        <p className="max-w-prose">
          ...
          Policy or the Cookies div of our Privacy Policy.
        </p>
        <h2 className="mt-2 text-3xl">Use of Your Personal Data</h2>
        <p className="max-w-prose">The Company may use Personal Data for the following purposes:</p>
        <ul className="mt-2">
          <li className="list-disc relative left-12">
            <p className="max-w-prose">
              <p className="max-w-prose">
                <strong className="text-bold">To provide and maintain our Service</strong>, including to monitor the usage of our Service.
              </p>
            </p>
          </li>
          <li className="list-disc relative left-12">
            <p className="max-w-prose">
              <p className="max-w-prose">
                <strong className="text-bold">To manage Your Account:</strong> to manage Your registration as a user of the Service. The
          ...
          <li className="list-disc relative left-12">
            <p className="max-w-prose">
              <p className="max-w-prose">
                <strong className="text-bold">For the performance of a contract:</strong> the development, compliance and undertaking of the
          ...
          <li className="list-disc relative left-12">
            <p className="max-w-prose">
              <p className="max-w-prose">
                <strong className="text-bold">To contact You:</strong> To contact You by email, telephone calls, SMS, or other equivalent
          ...
          <li className="list-disc relative left-12">
            <p className="max-w-prose">
              <p className="max-w-prose">
                <strong className="text-bold">To provide You</strong> with news, special offers and general information about other goods,
          ...
          <li className="list-disc relative left-12">
            <p className="max-w-prose">
              <p className="max-w-prose">
                <strong className="text-bold">To manage Your requests:</strong> To attend and manage Your requests to Us.
              </p>
            </p>
          </li>
          <li className="list-disc relative left-12">
            <p className="max-w-prose">
              <p className="max-w-prose">
                <strong className="text-bold">For business transfers:</strong> We may use Your information to evaluate or conduct a merger,
          ...
          <li className="list-disc relative left-12">
            <p className="max-w-prose">
              <p className="max-w-prose">
                <strong className="text-bold">For other purposes</strong>: We may use Your information for other purposes, such as data
        ...
        <p className="max-w-prose">We may share Your personal information in the following situations:</p>
        <ul className="mt-2">
          <li className="list-disc relative left-12">
            <p className="max-w-prose">
              <strong className="text-bold">With Service Providers:</strong> We may share Your personal information with Service Providers to
              monitor and analyze the use of our Service, to contact You.
            </p>
          </li>
          <li className="list-disc relative left-12">
            <p className="max-w-prose">
              <strong className="text-bold">For business transfers:</strong> We may share or transfer Your personal information in connection
          ...
          <li className="list-disc relative left-12">
            <p className="max-w-prose">
              <strong className="text-bold">With Affiliates:</strong> We may share Your information with Our affiliates, in which case we will
          ...
          <li className="list-disc relative left-12">
            <p className="max-w-prose">
              <strong className="text-bold">With business partners:</strong> We may share Your information with Our business partners to offer
              You certain products, services or promotions.
            </p>
          </li>
          <li className="list-disc relative left-12">
            <p className="max-w-prose">
              <strong className="text-bold">With other users:</strong> when You share personal information or otherwise interact in the public
          ...
          <li className="list-disc relative left-12">
            <p className="max-w-prose">
              <strong className="text-bold">With Your consent</strong>: We may disclose Your personal information for any other purpose with
              Your consent.
            </p>
          </li>
        </ul>
        <h2 className="mt-2 text-3xl">Retention of Your Personal Data</h2>
        <p className="max-w-prose">
        ...
        <h2 className="mt-2 text-3xl">Transfer of Your Personal Data</h2>
        <p className="max-w-prose">
        ...
        <h2 className="mt-2 text-3xl">Disclosure of Your Personal Data</h2>
        <h2 className="mt-2 text-2xl">Business Transactions</h2>
        <p className="max-w-prose">
        ...
        <h2 className="mt-2 text-2xl">Law enforcement</h2>
        <p className="max-w-prose">
        ...
        <h2 className="mt-2 text-2xl">Other legal requirements</h2>
        <p className="max-w-prose">The Company may disclose Your Personal Data in the good faith belief that such action is necessary to:</p>
        <ul className="mt-2">
          <li className="list-disc relative left-12">
            <p className="max-w-prose">Comply with a legal obligation</p>
          </li>
          <li className="list-disc relative left-12">
            <p className="max-w-prose">Protect and defend the rights or property of the Company</p>
          </li>
          <li className="list-disc relative left-12">
            <p className="max-w-prose">Prevent or investigate possible wrongdoing in connection with the Service</p>
          </li>
          <li className="list-disc relative left-12">
            <p className="max-w-prose">Protect the personal safety of Users of the Service or the public</p>
          </li>
          <li className="list-disc relative left-12">
            <p className="max-w-prose">Protect against legal liability</p>
          </li>
        </ul>
        <h2 className="mt-2 text-3xl">Security of Your Personal Data</h2>
        <p className="max-w-prose">
        ...
        <h2 className="mt-2">Children's Privacy</h2>
        <p className="max-w-prose">
        ...
        <h2 className="mt-2">Links to Other Websites</h2>
        <p className="max-w-prose">
        ...
        <h2 className="mt-2">Changes to this Privacy Policy</h2>
        <p className="max-w-prose">
      ...
      <p className="max-w-prose">If you have any questions about this Privacy Policy, You can contact us:</p>
      <ul className="mt-2">
        <li className="list-disc relative left-12">
          <p className="max-w-prose">By email: support@praxisco.us</p>
        </li>
      </ul>
    </div>
  )
